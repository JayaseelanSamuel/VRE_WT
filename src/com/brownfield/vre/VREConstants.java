...
public class VREConstants {
	...
	public static final String WELL_TEST_NEW_QUERY = "SELECT WELL_TEST_ID, STRING_ID, QL1, WHP1, TEST_START_DATE, TEST_END_DATE, TRY_CONVERT(VARCHAR(10), TEST_END_DATE, 120) AS EFFECTIVE_DATE, "
	...
	public static final String VRE_DATASET_QUERY = "SELECT T.*, DAM.RECORDED_DATE, DAM.AVG_WHP, DD.WATER_CUT_LAB, DAM.AVG_DOWNHOLE_PRESSURE, DAM.AVG_GASLIFT_INJ_RATE, "
			+ " DAM.AVG_HEADER_PRESSURE, DD.CHOKE_SETTING " + " FROM ( "
	...
	public static final String VRE_DURATION_QUERY = "SELECT T.*, DAM.RECORDED_DATE, DAM.AVG_WHP, DD.WATER_CUT_LAB, DAM.AVG_DOWNHOLE_PRESSURE, DAM.AVG_GASLIFT_INJ_RATE, "
			+ "	DAM.AVG_HEADER_PRESSURE, DD.CHOKE_SETTING, WT.QL1, CAST(IIF(WT.TEST_END_DATE IS NOT NULL, 1, 0) AS BIT) AS RECAL, ISNULL(VR.WATER_CUT,0) WATER_CUT "
	...
	public static final String VRE_MODEL_RESET_QUERY = "SELECT VRE_ID,STRING_ID, VRE1,WATER_CUT,GOR,PI,HOLDUP,FRICTION_FACTOR,RESERVOIR_PRESSURE "
			+ " FROM VIRTUAL_RATE_ESTIMATION " + "	WHERE STRING_ID = ? AND "
			+ "	( (RECORDED_DATE = ? ) OR RECORDED_DATE = (SELECT MAX(RECORDED_DATE) FROM VIRTUAL_RATE_ESTIMATION WHERE STRING_ID = ? ) ) "
